...
export default function Home() {
  return (
    <>
      ...
      <Text as="h5" fontSize={20} mb={4} textAlign="center">
        Try some encryption algorithms and share secret messages!
      </Text>
      ...
      <SimpleGrid columns={[1, 1, 2]} spacing={8}>
        ...
        <NextLink href="/columnarTransposition">
          <LinkBox as="article" p="5" borderWidth="1px" rounded="md">
            ...
            <Heading size="md" my="2">
              <LinkOverlay href="#">Columnar transposition cipher</LinkOverlay>
            </Heading>
            <Text>
              ...
              some scrambled order. Both the width of the rows and the
